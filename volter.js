...
//PEMBATAS=======================================
	...
	case 'op203': {
		...
		await volter.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case 'promote': {
		if (!m.isGroup) throw mess.group
 ...
 ➲ *Pesan : ${q ? q : 'kosong'}*\n\n`
		...
		if (!text) throw 'Masukkan Query text!'
            ...
            case 'linkgroup': case 'linkgc': {
                if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
                let response = await voltrr.groupInviteCode(m.chat)
		...
		let wokwol = await volter.serializeM(await m.getQuotedObj())
	    ...
	    break
            case 'listpc': {
                 ...
                 volter.sendTextWithMentions(m.chat, teks, m)
             }
             break
                case 'listgc': {
                 ...
                 for (let i of anu) {
                     let metadata = await volter.groupMetadata(i)
             ...
             case 'listonline': case 'liston': {
                    ...
                    volter.sendText(m.chat, 'List Online:\n\n' + online.map(v => '⌗ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
            case 'ebinary': {
        ...
        case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
                ...
                volter.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
`.trim()
                volter.sendText(m.chat, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break
            case 'lockcmd': {
                if (!isCreator) throw mess.owner
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'getmsg': {
                ...
                volter.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                volter.sendListMsg(m.chat, `pilih aja *${pushname}* Setmenu nya!`, nyoutube, `*Hello Kak* !`, `Pilih Set Menu`, sections, m)
                }
            }
            break
...
break;
		...
		let { pinterest } = require('./lib/scraper')
                ...
                volter.sendMessage(m.chat, { image: { url: result }, caption: '⌗ Media Url : '+result }, { quoted: m })
            }
            break
case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
                m.reply(mess.wait)
                volter.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'Generate Random ' + command }, { quoted: m })
            }
            break
            case 'waifu': {
            	m.reply(mess.wait)
	    ...
	    case 'couple': {
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                volter.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male` }, { quoted: m })
                volter.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female` }, { quoted: m })
            }
	    break
		...
		let buttons = [{ buttonId: `gcsearch ${text}`, buttonText: { displayText: 'Next' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⌕ Donasi' }, type: 1 }]
            await volter.sendButtonText(m.chat, buttons, jwbn, nyoutube, m, {quoted: fgclink})
            }
            break
            case 'wikimedia': {
                if (!text) throw 'Masukkan Query Title'
		let { wikimedia } = require('./lib/scraper')
            ...
            case 'tinyurl': case 'isgd': case 'vurl': case 'clp': {
                ...
                volter.sendMessage(m.chat, buttonMessage, { quoted: fdoc })
            }
            break
...
//Pembatas========================================
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            case 'ffcover': case 'crossfire': case 'galaxy': case 'glass': case 'neon': case 'beach': case 'blackpink': case 'igcertificate': case 'ytcertificate': {
                ...
                m.reply(mess.wait)
                volter.sendMessage(m.chat, { image: { url: api('zenz', '/ephoto/' + command, { text: text }, 'apikey') }, caption: `Ephoto ${command}` }, { quoted: m })
            }
            break
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Mimpi :* ${anu.message.mimpi}\n⌗ *Arti :* ${anu.message.arti}\n⌗ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Nama Anda :* ${anu.message.nama_anda.nama}\n⌗ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⌗ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⌗ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⌗ *Hasil :* ${anu.message.result}\n⌗ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Nama Suami :* ${anu.message.suami.nama}\n⌗ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\n⌗ *Nama Istri :* ${anu.message.istri.nama}\n⌗ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\n⌗ *Hasil :* ${anu.message.result}\n⌗ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Nama :* ${anu.message.nama}\n⌗ *Arti :* ${anu.message.arti}\n⌗ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendImage(m.chat,  anu.message.gambar, `⌗ *Nama Anda :* ${anu.message.nama_anda}\n⌗ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⌗ *Sisi Positif :* ${anu.message.sisi_positif}\n⌗ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⌗ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Lahir :* ${anu.message.hari_lahir}\n⌗ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Analisa :* ${anu.message.analisa}\n⌗ *Angka Akar :* ${anu.message.angka_akar}\n⌗ *Sifat :* ${anu.message.sifat}\n⌗ *Elemen :* ${anu.message.elemen}\n⌗ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendImage(m.chat, anu.message.image, `⌗ *Lahir :* ${anu.message.tgl_lahir}\n⌗ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⌗ *Arti :* ${anu.message.arti}\n⌗ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            ...
            case 'haribaik': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Lahir :* ${anu.message.tgl_lahir}\n⌗ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⌗ *Info :* ${anu.message.info}\n⌗ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Hari Lahir :* ${anu.message.hari_lahir}\n⌗ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⌗ *Hari Naas :* ${anu.message.hari_naas}\n⌗ *Info :* ${anu.message.catatan}\n⌗ *Catatan :* ${anu.message.info}`, m)
            }
            break
            ...
            case 'weton': case 'wetonjawa': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Tanggal :* ${anu.message.tanggal}\n⌗ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⌗ *Watak Hari :* ${anu.message.watak_hari}\n⌗ *Naga Hari :* ${anu.message.naga_hari}\n⌗ *Jam Baik :* ${anu.message.jam_baik}\n⌗ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                volter.sendText(m.chat, `⌗ *Hasil :* ${anu.message.result}\n⌗ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
...
//PEMBATAS=======================================
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return m.reply(anu.result.message)
                    volter.sendMedia(m.chat, anu.caption.profile_hd, '', `⌗ Full Name : ${anu.caption.full_name}\n⌗ User Name : ${anu.caption.user_name}\n⌗ ID ${anu.caption.user_id}\n⌗ Followers : ${anu.caption.followers}\n⌗ Following : ${anu.caption.following}\n⌗ Bussines : ${anu.caption.bussines}\n⌗ Profesional : ${anu.caption.profesional}\n⌗ Verified : ${anu.caption.verified}\n⌗ Private : ${anu.caption.private}\n⌗ Bio : ${anu.caption.biography}\n⌗ Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
           ...
           /**case 'tiktokwm': case 'tiktokwatermark': {
	        ...
	        case 'instagram': case 'ig': case 'igdl': {
                ...
                if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
                    ...
                    for (let media of anu.data) volter.sendFileUrl(m.chat, media, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                } else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('zenz', '/downloader/instastory', { url: isUrl(text)[0] }, 'apikey'))
                    volter.sendFileUrl(m.chat, anu.media[0].url, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                }
            }
            break
            case 'joox': case 'jooxdl': {
                ...
                let msg = await volter.sendImage(m.chat, anu.result.img, `⌗ Title : ${anu.result.lagu}\n⌗ Album : ${anu.result.album}\n⌗ Singer : ${anu.result.penyanyi}\n⌗ Publish : ${anu.result.publish}\n⌗ Lirik :\n${anu.result.lirik.result}`, m)
                volter.sendMessage(m.chat, { audio: { url: anu.result.mp4aLink }, mimetype: 'audio/mpeg', fileName: anu.result.lagu+'.m4a' }, { quoted: msg })
            }
            break
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await volter.sendImage(m.chat, anu.result.thumb, `⌗ Title : ${anu.result.title}\n⌗ Url : ${isUrl(text)[0]}`)
                volter.sendMessage(m.chat, { audio: { url: anu.result.url }, mimetype: 'audio/mpeg', fileName: anu.result.title+'.m4a' }, { quoted: msg })
            }
            break
		    ...
		    image: { url: anu.result.thumb },
                ...
                let msg = await volter.sendMessage(m.chat, buttonMessage, { quoted: m })
                volter.sendMessage(m.chat, { audio: { url: anu.result.audio } }, { quoted: msg })
            }
            break
	        case 'fbdl': case 'fb': case 'facebook': {
                ...
                volter.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `⌗ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
	        case 'pindl': case 'pinterestdl': {
                ...
                volter.sendMessage(m.chat, { video: { url: anu.result }, caption: `Download From ${text}` }, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        volter.sendMessage(m.chat, { image: { url }, caption: `⌗ Title : ${anu.title}\n⌗ Author : ${anu.author.name}\n⌗ Like : ${anu.like}\n⌗ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
		...
		let result = anu[Math.floor(Math.random() * anu.length)]
		volter.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
	    }
	    break
		case 'iqra': {
		...
		volter.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		/**case 'juzamma': {
		if (args[0] === 'pdf') {
		m.reply(mess.wait)
		volter.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		m.reply(mess.wait)
		volter.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		m.reply(mess.wait)
		volter.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		m.reply(mess.wait)
		volter.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		volter.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : m })
		}
		break
		case 'tafsirsurah': {
...
⌗ Detail: ${detail}`
            volter.sendImage(m.chat, thumb, capt, m)
            }
            break
            case 'jadwalbioskop': {
            ...
            volter.sendImage(m.chat, res.result[0].thumb, capt, m)
            }
            break
            ...
            volter.sendImage(m.chat, res.result[0].img, capt, m)
            }
            break
            case 'aminio': {
            ...
            volter.sendImage(m.chat, 'https://'+res.result[0].community_thumb, capt, m)
            }
            break
            case 'wattpad': {
            ...
            volter.sendImage(m.chat, res.result[0].thumbnail, capt, m)
            }
            break
...
├ *Mode* : ${volter.public ? 'Public' : `Self`}
├ *Prefix* :「 MULTI-PREFIX 」
╰──❏
...
_Support kami_\n_Dengan Cara Berdonasi_`
            ...
            await volter.sendButtonText(m.chat, buttons, anu, nyoutube, m, {mentions: ments, quoted: fkontak})
            }
            break
